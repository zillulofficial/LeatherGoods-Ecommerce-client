                ...
                <Link to='/leatherCollection'>
                    <div className='relative cursor-pointer h-[400px] overflow-hidden group '>
                        <div className=" flex flex-col justify-end w-full h-full px-8 py-6 transition-opacity duration-700 opacity-0 brightness-100 hover:brightness-75 backdrop-blur-sm group-hover:opacity-100">
                            ...
                            <p className='text-gray-100'>Premium quality with a natural look and burnishing effect.</p>
                        </div>
                ...
                <Link to='/leatherCollection'>
                    <div className='relative cursor-pointer h-[400px] overflow-hidden group '>
                        <div className=" flex flex-col justify-end w-full h-full px-8 py-6 transition-opacity duration-700 opacity-0 brightness-100 hover:brightness-75 backdrop-blur-sm group-hover:opacity-100">
                            ...
                            <p className='text-gray-100'>Luxuriously soft with a smooth or milled texture.</p>
                        </div>
                ...
                <Link to='/leatherCollection'>
                    <div className='relative cursor-pointer h-[400px] overflow-hidden group '>
                        <div className=" flex flex-col justify-end w-full h-full px-8 py-6 transition-opacity duration-700 opacity-0 brightness-100 hover:brightness-75 backdrop-blur-sm group-hover:opacity-100">
                            ...
                            <p className='text-gray-100'>Perfect for high-end fashion and upholstery.</p>
                        </div>
                ...
                <Link to='/leatherCollection'>
                    <div className='relative cursor-pointer h-[400px] overflow-hidden group '>
                        <div className=" flex flex-col justify-end w-full h-full px-8 py-6 transition-opacity duration-700 opacity-0 brightness-100 hover:brightness-75 backdrop-blur-sm group-hover:opacity-100">
                            ...
                            <p className='text-gray-100'>Deep-dyed for rich, consistent color and durability.</p>
                        </div>
                ...
                <Link to='/leatherCollection'>
                    <div className='relative cursor-pointer h-[400px] overflow-hidden group '>
                        <div className=" flex flex-col justify-end w-full h-full px-8 py-6 transition-opacity duration-700 opacity-0 brightness-100 hover:brightness-75 backdrop-blur-sm group-hover:opacity-100">
                            ...
                            <p className='text-gray-100'>Eco-friendly, soft, and flexible.</p>
                        </div>
                ...
                <Link to='/leatherCollection'>
                    <div className='relative cursor-pointer h-[400px] overflow-hidden group '>
                        <div className=" flex flex-col justify-end w-full h-full px-8 py-6 transition-opacity duration-700 opacity-0 brightness-100 hover:brightness-75 backdrop-blur-sm group-hover:opacity-100">
                            ...
                            <p className='text-gray-100'>Ideal for premium footwear.</p>
                        </div>
                ...
                <Link to='/leatherCollection'>
                    <div className='relative cursor-pointer h-[400px] overflow-hidden group '>
                        <div className=" flex flex-col justify-end w-full h-full px-8 py-6 transition-opacity duration-700 opacity-0 brightness-100 hover:brightness-75 backdrop-blur-sm group-hover:opacity-100">
                            ...
                            <p className='text-gray-100'>Durable and comfortable for shoe interiors.</p>
                        </div>
                ...
                <Link to='/leatherCollection'>
                    <div className='relative cursor-pointer h-[400px] overflow-hidden group '>
                        <div className=" flex flex-col justify-end w-full h-full px-8 py-6 transition-opacity duration-700 opacity-0 brightness-100 hover:brightness-75 backdrop-blur-sm group-hover:opacity-100">
                            ...
                            <p className='text-gray-100'>Strong and flexible for long-lasting wear.</p>
                        </div>
                ...
                <Link to='/leatherCollection'>
                    <div className='relative cursor-pointer h-[400px] overflow-hidden group '>
                        <div className=" flex flex-col justify-end w-full h-full px-8 py-6 transition-opacity duration-700 opacity-0 brightness-100 hover:brightness-75 backdrop-blur-sm group-hover:opacity-100">
                            ...
                            <p className='text-gray-100'>ustainable and eco-friendly option.</p>
                        </div>
