            ...
            <div className=' mb-16'>
                ...
                >
                    ...
                    <SwiperSlide>
                        ...
                        <div className='absolute top-1/4 lg:top1/3 lg:left-72 md:left-48 left-24'>
                            <p className='text-2xl md:text-6xl lg:text-7xl text-white uppercase mb-8 '>Sourcing the <br className='hidden md:block' />Finest <span className='text-[#ffdb9f]'>Leather</span><br className='hidden md:block' /> Globally </p>
                ...
                {/*  */}
                {/* md:w-full md:-bottom-80 md:left-1/12 md:absolute md:grid-cols-2 */}
                <div className='container mx-auto lg:-bottom-32 z-10 w-1/2 bg-white shadow-2xl grid grid-cols-1  lg:grid-cols-4 lg:w-full lg:grid lg:left-1/12 lg:absolute  md:hidden'>
