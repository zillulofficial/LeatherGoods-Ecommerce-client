...
const AddItems = () => {
    ...
    const onSubmit = async (data) => {
        ...
        // console.log(newData);
        axiosPublic.post('/items', newData)
            .then(res => {
    ...
    return (
        <div className='mt-16'>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-6 md:flex-row p-16 container mx-auto bg-white shadow-lg rounded-xl">
                {/* adding picture */}
                <div className=' border border-dashed p-10 flex flex-col gap-5 justify-center items-center'>
                ...
                <div className='w-full'>
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-6">
                        ...
                        <div>
                            ...
                            <input {...register("name", { required: true })} className="w-full border rounded-md border-gray-300 pl-3 py-2" placeholder="name" type="text" />
                        </div>
                        {/* type */}
                        <div>
                        ...
                        <div>
                            ...
                            <input {...register("price", { required: true })} className="w-full border rounded-md border-gray-300 pl-3 py-2" placeholder="Enter price" type="text" />
                        </div>
                    </div>
                    {/* description */}
                    <div>
